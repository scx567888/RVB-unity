...
namespace rvb.scripts {
    ...
    public class SheepRoleTypeInfo {
        ...
        public SheepCollideGroup collideId;
        public int animId;
        public int skinId;
        public float scale;
    ...
    public static class SheepRoleTypeInfos {
        ...
        public static readonly SheepRoleTypeInfo pao_che = new() {
            ...
            collideId = SheepCollideGroup.GROUP3,
            animId = 106,
            scale = 9f,
            detectCollideR = 4,
            collideR = 225f,
        ...
        public static readonly SheepRoleTypeInfo xuan_feng_zhan = new() {
            ...
            collideId = SheepCollideGroup.GROUP5,
            animId = 105,
            scale = 7f,
            detectCollideR = 2,
            collideR = 112.5f,
        ...
        public static readonly SheepRoleTypeInfo xian_feng_bing = new() {
            ...
            pla = "dy",
            roleType = SheepRoleType.xuan_feng_zhan,
            collideId = SheepCollideGroup.GROUP7,
            animId = 8,
            scale = 7.5f,
            detectCollideR = 3,
            collideR = 180f,
        ...
        public static readonly SheepRoleTypeInfo xiao_bing = new() {
            ...
            collideId = SheepCollideGroup.GROUP0,
            animId = 100,
            scale = 3f,
            detectCollideR = 2,
            collideR = 110f,
        ...
        public static readonly SheepRoleTypeInfo ci_ke = new() {
            ...
            collideId = SheepCollideGroup.GROUP1,
            animId = 101,
            scale = 6f,
            detectCollideR = 2,
            collideR = 112.5f,
        ...
        public static readonly SheepRoleTypeInfo gong_jian_shou = new() {
            ...
            collideId = SheepCollideGroup.GROUP2,
            animId = 102,
            scale = 5f,
            detectCollideR = 3,
            collideR = 180f,
        ...
        public static readonly SheepRoleTypeInfo chong_feng_bing = new() {
            ...
            collideId = SheepCollideGroup.GROUP4,
            animId = 104,
            scale = 7f,
            detectCollideR = 5,
            collideR = 240f,
        ...
        public static readonly SheepRoleTypeInfo yang_shen = new() {
            ...
            collideId = SheepCollideGroup.GROUP8,
            animId = 107,
            scale = 20f,
            detectCollideR = 6,
            collideR = 300f,
        ...
        public static readonly SheepRoleTypeInfo qi_lin = new() {
            ...
            collideId = SheepCollideGroup.GROUP6,
            animId = 108,
            scale = 12f,
            detectCollideR = 10,
            collideR = 480f,
